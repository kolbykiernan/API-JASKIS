...
// I'm not sure what I'm doing wrong here because it's also returning Scavengers who haven't captured an animal with a reward greater than $11000. 

db.scavengers.find({captured: {$gt: {reward: 11000}}})
